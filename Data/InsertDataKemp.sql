...
-- NFC Championship (GameID will become 12 automatically if identity)
EXEC procSceduleGame
    @HomeTeamID = 32,   -- Seahawks
    @AwayTeamID = 30,   -- Rams
    @GameRound = 'Conference',
    @GameDate = '2026-01-25',
    @GameStartTime = '18:30',
...
-- Super Bowl (GameID will become 13)
EXEC procSceduleGame
    @HomeTeamID = 32,   -- Seahawks
    @AwayTeamID = 11,   -- Patriots
    @GameRound = 'Super Bowl',
    @GameDate = '2026-02-08',
    @GameStartTime = '18:30',
    @StadiumID = 29,    -- Levi’s Stadium
    @NFLAdminID = 5;
...
EXEC procEnterScores
    ...
    SELECT *
FROM Game
WHERE GameID IN (11, 13, 14);



SELECT *
FROM AdminChangesTracker
